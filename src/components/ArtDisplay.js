    ...
    <div>
      ...
      <div className="flex justify-center">
        <div
          ...
          className="mb-5 p-5 md:p-6 rounded-md grid grid-flow-row justify-center grid-cols-1 sm:grid-cols-2 gap-5"
        >
          {selected &&
            selected.map((i) => (
              <div>
                <div
                  ...
                  className="max-w-sm rounded overflow-hidden shadow-xs "
                >
                  {i.imageUrl ? (
